...
public class UpdateSingleIssueInReview
{
    ...
    public class Handler : IRequestHandler<Command, Unit>
    {
        ...
        {
            var issue = await _context.IssuesInReview.FirstOrDefaultAsync(o => o.Id == command.Issue.Id, cancellationToken);
            if (issue is null)
            {
                throw new Exception("Issue in Review not found in db");
            }
            else
            {
            ...
            throw new Exception("failed to update the Issue In Review");
        }
    }
}
